...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<span class=\"add-on\"><i class=\"icon-user\"></i></span><input autofocus class=\"input-large span10\" name=\"username\" id=\"username\" type=\"text\" value=\"admin\" />\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-primary\" ng-click=\"doLogin();\">Login</button>\n");
      out.write("\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t</fieldset>\n");
      out.write("\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t</div><!--/span-->\n");
